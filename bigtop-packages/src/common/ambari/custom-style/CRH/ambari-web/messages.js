...
Em.I18n.translations = {
  ...
  'installer.step1.advancedRepo.importantMassage':'<b>重要提示:</b> When using local mirror repositories, you only need to provide Base URLs for the Operating System you are installing for your Stack. Uncheck all other repositories.',
...
'admin.authentication.form.method.database':'使用 Ambari数据库对用户进行身份验证',
 ...
 'admin.highAvailability.wizard.header':'启动NameNode HA 向导',
  ...
  'admin.highAvailability.wizard.step9.task11.title':'停止所有服务',
