...
class HDP22StackAdvisor(HDP21StackAdvisor):
  ...
  def recommendMapReduce2Configurations(self, configurations, clusterData, services, hosts):
    ...
    putMapredProperty('yarn.app.mapreduce.am.command-opts', "-Xmx" + str(int(0.8 * int(configurations["mapred-site"]["properties"]["yarn.app.mapreduce.am.resource.mb"]))) + "m" + " -Dcrh.version=${crh.version}")
    servicesList = [service["StackServices"]["service_name"] for service in services["services"]]
