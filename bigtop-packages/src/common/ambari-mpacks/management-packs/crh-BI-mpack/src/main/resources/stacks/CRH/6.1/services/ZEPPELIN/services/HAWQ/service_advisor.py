...
# change common-service base dir to CRH 5.0 base dir
...
# Redefine class name that follows the naming convention for ServiceAdvisor
class CRH50HAWQServiceAdvisor(service_advisor.ServiceAdvisor):

  def __init__(self, *args, **kwargs):
    self.as_super = super(CRH50HAWQServiceAdvisor, self)
