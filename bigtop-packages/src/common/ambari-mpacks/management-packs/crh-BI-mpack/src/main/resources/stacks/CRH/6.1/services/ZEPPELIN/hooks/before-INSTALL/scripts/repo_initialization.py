...
def _alter_repo(action, repo_string, repo_template):
  ...
  @param repo_string: e.g. "[{\"baseUrl\":\"http://public-repo-1.hortonworks.com/HDP/centos6/2.x/updates/2.0.6.0\",\"osType\":\"centos6\",\"repoId\":\"CRH-2.0._\",\"repoName\":\"CRH\",\"defaultBaseUrl\":\"http://public-repo-1.hortonworks.com/CRH/centos6/2.x/updates/2.0.6.0\"}]"
  """
