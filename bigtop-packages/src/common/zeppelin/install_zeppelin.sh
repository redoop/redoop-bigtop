...
usage: $0 <options>
  ...
  Optional options:
     ...
     --lib-dir=DIR               path to install Zeppelin home [$CRH_DIR/zeppelin]
...
LIB_DIR=${LIB_DIR:-$CRH_DIR/zeppelin}
INSTALLED_LIB_DIR=${INSTALLED_LIB_DIR:-$CRH_DIR/zeppelin}
...
cp -a ${BUILD_DIR}/build/dist/{LICENSE,NOTICE,README.md,licenses} $PREFIX/$LIB_DIR/
