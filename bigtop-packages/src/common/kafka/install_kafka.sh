...
usage: $0 <options>
  ...
  Optional options:
     ...
     --lib-dir=DIR               path to install Kafka home [$CRH_DIR/kafka]
...
LIB_DIR=${LIB_DIR:-$CRH_DIR/kafka}
EXAMPLES_DIR=${EXAMPLES_DIR:-$DOC_DIR/examples}
CONF_DIR=${CONF_DIR:-/etc/kafka/conf.dist}
KAFKA_HOME=${KAFKA_HOME:-$CRH_DIR/kafka}
...
ln -sf $CRH_DIR/zookeeper/zookeeper.jar ${PREFIX}/${LIB_DIR}/libs/
