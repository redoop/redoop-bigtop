...
install -d -m 0755 $PREFIX/$LIB_DIR/../hadoop-yarn 
...
ln -s ../../spark/lib/spark-*-yarn-shuffle.jar spark-yarn-shuffle.jar
ln -s ../../spark/lib/datanucleus-api-jdo*.jar datanucleus-api-jdo.jar
ln -s ../../spark/lib/datanucleus-core*.jar datanucleus-core.jar
ln -s ../../spark/lib/datanucleus-rdbms*.jar datanucleus-rdbms.jar
popd
