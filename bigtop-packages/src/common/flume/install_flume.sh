...
usage: $0 <options>
  ...
  Optional options:
     ...
     --lib-dir=DIR               path to install flume home [$CRH_DIR/flume]
...
LIB_DIR=${LIB_DIR:-$CRH_DIR/flume}
BIN_DIR=${BIN_DIR:-$CRH_DIR/flume/bin}
...
# See FLUME-920
exec bash $CRH_DIR/flume/bin/flume-ng "\$@"
EOF
chmod 755 $wrapper
...
HADOOP_HOME=\${HADOOP_HOME:-$CRH_DIR/hadoop}
